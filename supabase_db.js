...
//  FIXED VERSION
//  Bugs fixed:
//  1. startDB() ka closing brace missing tha — dbDelete andar tha
//  2. Login ke time admins/employees fresh Supabase se load ho
// ================================================================
...
// ================================================================
//  setupRealtime() — Live changes dikhein
// ================================================================
...
(async function startDB() {
  ...
  try {
    ...
    // ================================================================
    // BUG FIX: Pehle session restore karo, phir app refresh karo
    // Iss se dusre systems pe bhi login sahi kaam karega
    // ================================================================
    if (typeof currentRole !== 'undefined' && currentRole) {
      // User pehle se login hai — fresh data ke saath refresh karo
      if (typeof renderPage === 'function') renderPage(currentPage);
      if (typeof updateBadges === 'function') updateBadges();
      if (typeof buildSidebar === 'function') buildSidebar();
    } else {
      // Session restore try karo — ab admins/employees Supabase se aa chuke hain
      ...
      // Agar session nahi tha — login page pe hi rehne do
    }
...
// ================================================================
// ⬆️ startDB() yahan band hoti hai — dbDelete BAHAR hai (FIX!)
// ================================================================
})();
